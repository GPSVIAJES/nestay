    ...
    <div id="view-home">
                    ...
                    <form action="{{ route('search') }}" method="GET" onsubmit="showLoader()">
                        <div class="sfields-mix">
                            <div class="sf-box">
                                ...
                                <input type="text" name="destination" id="dest" class="sf-val"
                                    placeholder="Ciudad, país o nombre..." required autocomplete="off">
                            </div>
                            <div class="sf-box">
                        ...
                        <div class="guest-hub-panel" id="guest-hub-panel">
                            <div class="hub-row">
                                ...
                                <div class="hub-ctrl">
                                    <button type="button" class="hub-btn"
                                        onclick="SearchMix.adjust('adults', -1)">−</button>
                            ...
                            <button type="button" class="btn-primary"
                                style="width:100%; margin-top:16px; border-radius:15px"
        ...
        <section class="hiw-mix" id="how">
            <div class="reveal">
                ...
                <div class="hiw-step on">
                    ...
                    <div class="h-body">
                        ...
                        <p class="h-desc">Ciudad, país o región. Nuestro motor busca en tiempo real entre 2.4M+ alojamientos
                            verificados en 190+ países.</p>
                    </div>
                </div>
                <div class="hiw-step">
                    ...
                    <div class="h-body">
                        ...
                        <p class="h-desc">Precio, categoría, valoración o amenities. Ve fotos reales y reseñas verificadas
                            antes de decidir.</p>
                    </div>
                </div>
                <div class="hiw-step">
                    ...
                    <div class="h-body">
                        ...
                        <p class="h-desc">Pago seguro, confirmación inmediata, bono en tu email. Sin comisiones ocultas. Tu
                            nido, garantizado.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="reveal d2" style="position:relative">
                <div
                    style="background:var(--wh); border-radius:40px; border:8px solid #333; height:500px; width:260px; margin:0 auto; overflow:hidden; box-shadow:var(--shl); position:relative">
                    <div style="background:#000; height:20px; width:120px; border-radius:0 0 12px 12px; margin:0 auto">
                    </div>
                    <!-- Mockup Content -->
                    <div style="padding:20px">
                        ...
                        <div
                            style="background:var(--tp); border:1px solid var(--tl); border-radius:12px; padding:12px; margin-bottom:12px">
                            <div style="font-size:12px; font-weight:700">🔍 Roma, Italia</div>
                        </div>
                        <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px">
                            <div style="background:var(--tp); border-radius:10px; padding:10px; font-size:10px">
                                LLEGADA<br><strong>15 Ago</strong></div>
                            <div style="background:var(--tp); border-radius:10px; padding:10px; font-size:10px">
                                SALIDA<br><strong>18 Ago</strong></div>
                        </div>
                        <div
                            style="margin-top:12px; background:var(--tp); border-radius:10px; padding:10px; font-size:10px">
                            2 huéspedes · 1 hab.</div>
                        <button
                            style="margin-top:20px; width:100%; background:var(--t); color:#fff; border:none; border-radius:10px; padding:12px; font-size:12px; font-weight:700">Buscar
                            nidos →</button>
                    </div>
                </div>
            </div>
        ...
        <section class="dest-mix" id="destinations">
            ...
            <h2 class="dest-h2" style="margin-top:12px">Viaja a donde siempre<br>has soñado ir</h2>
        ...
        <section style="padding: 100px 64px; background: var(--cr);">
            <div style="display:flex; justify-content:space-between; align-items:flex-end; margin-bottom:48px">
                <div>
                    <span
                        style="background:var(--tp); color:var(--t); padding:5px 12px; border-radius:100px; font-size:10px; font-weight:800; letter-spacing:1px">ALOJAMIENTOS
                        DESTACADOS</span>
                    <h2
                        style="font-family:'Fraunces',serif; font-size:48px; font-weight:800; color:var(--v); margin-top:12px">
                        Los más reservados ahora</h2>
                </div>
            ...
            <div style="display:grid; grid-template-columns: repeat(4, 1fr); gap:24px">
                ...
                <div class="pcard-mix">
                    <div class="p-img-box"
                        style="background-image: url('https://images.unsplash.com/photo-1449156001437-37e64b8dfce0?auto=format&fit=crop&q=80&w=600')">
                    </div>
                    <div class="p-body">
